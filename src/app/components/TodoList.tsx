                ...
                <tbody >
                    ...
                    <tr key={todo.id} className="border-1">
                        ...
                        <td className="w-50 h-6 flex flex-row">
                            ...
                            <button className="ml-90 basic-64 text-center bg-white text-indigo-600 hover:bg-indigo-600 hover:text-white border-1 rounded-full font-bold" onClick={() => mutation.mutate({
                                id : todo.id
                            })}>Xoa?</button>
                            </div>
                            <div className="basic-64 ml-10">
                            <button className="basic-64 text-center bg-white text-indi  go-600 hover:bg-indigo-600 hover:text-white border-1 rounded-full font-bold" onClick={() => mutation1.mutate({
                                id : todo.id,
